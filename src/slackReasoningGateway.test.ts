...
async function runTests(): Promise<void> {
  ...
  markJobSeen({
    id: "exact-draft-job",
    title: "Exact Draft Workflow Job",
    url: "https://www.upwork.com/jobs/~055053866890130225262",
    description: "Workflow support work.",
    budget: "$80/hr",
    ...
    score: 91,
    matchLevel: "high",
    matchedKeywords: ["Workflow support"],
    negativeKeywords: [],
    scoreBreakdown: {
  ...
  saveApplicationDraft({
    ...
    connectsStrategy: {
      ...
      sourceBackedConnects: {
        ...
        totalConnects: 8,
        confidence: "high",
        sourceText: "8 Connects required",
        sourceLocation: "test fixture",
        extractionMethod: "deterministic_visible_text",
      },
      reasons: ["test fixture is safe to prep"],
      risks: [],
    },
    ...
    jobUnderstanding: {
      jobTitle: "Exact Draft Klaviyo Job",
      fullJobDescription: "Klaviyo lifecycle work.",
      actualJobRequest: "Klaviyo lifecycle work.",
      clientBusiness: "DTC ecommerce brand",
      customerType: "repeat ecommerce customers",
      commercialPain: "post-purchase leak",
      emotionalPain: "lifecycle uncertainty",
      likelyLifecycleOrConversionLeak: "post-purchase and winback flows",
      desiredOutcome: "improve retention revenue",
      requestedTools: ["Klaviyo"],
      requestedDeliverables: ["Lifecycle audit"],
      unknowns: [],
    },
    brandFactPack: {
      brandName: "Exact Draft Client",
      websiteUrls: [],
      whatTheBrandSells: "DTC products",
      productCategory: "ecommerce",
      targetCustomerIcp: "repeat ecommerce buyers",
      customerBuyingMoment: "post-purchase",
      repeatPurchaseMoment: "winback window",
      emotionalPainOrDesire: "make lifecycle work feel clear",
      likelyLifecycleLeak: "post-purchase leak",
      likelyConversionLeak: "unclear lifecycle path",
      customerEducationGaps: [],
      objectionsOrTrustGaps: [],
      languageOrHooks: [],
      proofAngle: "retention cleanup",
      assumptions: [],
      whatNotToClaim: [],
      confidence: "medium",
      sources: [],
      ...
      webResearchProvider: "disabled",
      webResearchStatus: "not_applicable",
      webResearchQuery: "",
      researchSummary: "Not needed for test fixture.",
    },
    copyStrategy: {
      job_title: "Exact Draft Klaviyo Job",
      client_business: "DTC ecommerce brand",
      brand_name: "Exact Draft Client",
      brand_url: "",
      category: "retention",
      target_customer: "repeat ecommerce buyers",
      customer_state_of_mind: "needs lifecycle clarity",
      customer_pain_or_desire: "post-purchase leak",
      client_commercial_pain: "lost retention revenue",
      cost_of_inaction: "continued leakage",
      money_leak: "post-purchase leak",
      buying_moment: "after purchase",
      repeat_purchase_or_conversion_moment: "winback path",
      likely_lifecycle_gap: "post-purchase and winback flows",
      offer_or_project_mechanism: "Klaviyo lifecycle cleanup",
      retention_lane: "post-purchase",
      proof_angle: "Fly Boutique lifecycle proof",
      proof_verification_state: "planned",
      requested_tools: ["Klaviyo"],
      requested_deliverables: ["Lifecycle audit"],
      tone: "direct",
      opening_angle: "post-purchase leak",
      one_sentence_sales_argument: "Fix the first lifecycle leak before adding more campaigns.",
      cta: "Map fixes this week.",
      unknowns: [],
      do_not_claim: [],
    },
    proofStrategy: {
      selectedProofNames: ["Fly Boutique"],
      selectedAttachmentPaths: [],
      selectedPortfolioHighlights: [],
      proofVerificationState: "planned",
      summary: "Use Fly Boutique as proof context.",
      warnings: [],
    },
    draftQualityGate: {
      ready: true,
    ...
    skillUseTrace: {
      ...
      selectedSkills: [{
        ...
        title: "Proposal copywriting",
        stage: "cover_letter_drafting",
        reason: "test fixture requires browser-fill-ready draft",
        mandatory: true,
        loaded: true,
      ...
      jobDescriptionLength: "Klaviyo lifecycle work.".length,
      captureConfidence: "high",
      invocationOrder: ["cover_letter_drafting:proposal-copywriting"],
      brandFactPackSummary: "Test fixture brand facts.",
      copyStrategySummary: "Test fixture copy strategy.",
      proofStrategySummary: "Test fixture proof strategy.",
