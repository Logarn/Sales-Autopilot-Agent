...
## Purpose
Draft Steve-voice application copy and structured Slack-ready proposal sections.
...
## Required inputs
ScoredJob, selected proof, profile voice/knowledge
...
For a DTC brand with abandoned-cart leaks, open with the lifecycle revenue problem rather than 'I am excited to apply'.
...
Recommended next skill: `proposal-critic`. Include the output schema above so the next skill can continue without rereading broad context.
