# Connects Governor Skill

## Purpose
Protect Connects and bid/boost decisions.
...
## Required inputs
ScoredJob connectsRequired, client quality, profile/connects-rules.json
...
A 16-Connect job with weak client spend is held for approval; no max bid or boost is recommended automatically.
...
Recommended next skill: `slack-packet or human approval`. Include the output schema above so the next skill can continue without rereading broad context.
