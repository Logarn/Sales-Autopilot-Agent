...
## Purpose
Score opportunity fit, client quality, red flags, and Connects risk.
...
## Required inputs
JobPosting/ScoredJob, profile/profile.json, connects rules
...
A Klaviyo audit for a Shopify skincare brand scores high; a commission-only lead-gen role is skipped despite email keywords.
...
Recommended next skill: `proposal-writing or connects-governor`. Include the output schema above so the next skill can continue without rereading broad context.
