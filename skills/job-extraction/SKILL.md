# Job Extraction Skill

## Purpose
Turn raw Upwork/search/captured text into a conservative JobPosting.
...
## Required inputs
source result, direct Upwork URL or pasted job-detail text
...
A pasted Beauty Brand Klaviyo page yields title, description, hourly budget, Connects, client spend, skills, and direct URL.
...
Recommended next skill: `llm-normalization or fit-scoring`. Include the output schema above so the next skill can continue without rereading broad context.
