...
## Required inputs
Slack message context, human replies/decisions, job id
...
Steve replies 'revise opening, mention Trattoria DTC proof'; the skill treats it as guidance, not approval to auto-submit.
