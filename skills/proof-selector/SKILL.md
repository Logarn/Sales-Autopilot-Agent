# Proof Selector Skill

## Purpose
Choose relevant portfolio proof and attachments for the job.
...
## Required inputs
JobPosting/ScoredJob, profile/portfolio.json, profile knowledge
...
For a Shopify/Klaviyo retention job, select retention audit proof instead of unrelated paid social examples.
...
Recommended next skill: `proposal-writing`. Include the output schema above so the next skill can continue without rereading broad context.
