...
## Purpose
Format a human approval packet for Slack webhook delivery.
...
## Required inputs
ScoredJob, ApplicationDraft, proof, critic score, connects plan
...
Post a packet with score, risks, proposal sections, proof, and Upwork URL for Steve to review manually.
...
Recommended next skill: `slack-conversation or browser-apply`. Include the output schema above so the next skill can continue without rereading broad context.
